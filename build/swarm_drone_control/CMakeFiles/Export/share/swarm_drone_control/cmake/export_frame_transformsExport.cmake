...
foreach(_expectedTarget swarm_drone_control::frame_transforms)
...
# Create imported target swarm_drone_control::frame_transforms
add_library(swarm_drone_control::frame_transforms SHARED IMPORTED)

set_target_properties(swarm_drone_control::frame_transforms PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/usr/include/eigen3;${_IMPORT_PREFIX}/include/swarm_drone_control;${_IMPORT_PREFIX}/include"
